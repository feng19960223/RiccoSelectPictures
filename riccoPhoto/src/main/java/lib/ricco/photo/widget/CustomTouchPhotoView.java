...
/**
 * 支持 旋转 缩放 平移的ImageView
 */

public class CustomTouchPhotoView extends AppCompatImageView {
    ...
    public CustomTouchPhotoView(Context context) {
        super(context);
        setScaleType(ScaleType.MATRIX);
    }

    public CustomTouchPhotoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setScaleType(ScaleType.MATRIX);
    }

    public CustomTouchPhotoView(Context context, AttributeSet attrs, int defStyleAttr) {
